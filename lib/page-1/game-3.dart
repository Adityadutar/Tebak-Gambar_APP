    ...
    return Container(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            Container(
              // autogroup4yytiFp (6d9PLUAxQ6Sa96SHiu4YyT)
              ...
              child: Column(
                ...
                children: [
                  Container(
                    // timerSSi (9:123)
                    margin: EdgeInsets.fromLTRB(14*fem, 0*fem, 13*fem, 35*fem),
                    width: double.infinity,
                    height: 13*fem,
                    decoration: BoxDecoration (
                  ...
                  Container(
                    ...
                    height: 318*fem,
                    child: Image.asset(
                      'assets/page-1/images/intersect-AYn.png',
                      width: 322*fem,
                      height: 318*fem,
                    ),
                  ),
                  Container(
                    // selesaikanpuzzelini2fp (9:122)
            ...
            Container(
              // autogroupb3mojq8 (6d9PBPbkU5PAU6QE6bB3mo)
